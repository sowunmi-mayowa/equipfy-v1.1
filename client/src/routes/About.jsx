    ...
    <div>
      ...
      <div className="pt-8 mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl">
        <div className="flex flex-col items-center justify-center text-center">
          <h1 className="text-eBlack font-aeonik text-xl md:text-[36px] md:leading-[40px] mb-2 font-bold max-w-3xl">
            We offer Greater Selection, Neutral Brands of various Equipment
          </h1>
        ...
        <div className="my-8">
          <div className="flex flex-col lg:flex-row items-baseline justify-center gap-10">
            <div className="flex flex-col justify-center items-center text-center">
              ...
              <p className="text-base text-gray-500 font-aeonik text-center font-normal">
                Increasing your fleet or building your construction company? Buy
                machines in pristine condition on equipfy at affordable prices.
              </p>
            </div>
            <div className="flex flex-col justify-center items-center text-center">
              ...
              <p className="text-base text-gray-500 font-aeonik text-center font-normal">
                ...
                need to do their best work and also we prioritize your team's
            ...
            <div className="flex flex-col justify-center items-center text-center">
              ...
              <p className="text-base text-gray-500 font-aeonik text-center font-normal">
                Finding the right parts at the right timeand at the right place
                is vital for your business.eQuipfy is the best resource for new
                and used equipment parts..
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#F9FAFB] mb-8">
        <div className="py-8 mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl">
          <div className="flex flex-col justify-center items-center gap-4">
            <h1 className="text-eBlack text-xl md:text-2xl lg:text-6xl text-center font-semibold font-plex md:leading-8 capitalize">
              meet our team
            </h1>
            <p className="max-w-lg text-center text-[#747474] font-aeonik text-base font-medium">
              Dedicated to ensuring our clients' satisfaction, is the friendly
              face that goes above and beyond to meet our clients' needs.
            </p>
          </div>
