            ...
            <div className="flex flex-col md:flex-row items-stretch gap-0">
              ...
              <div className="w-full md:w-1/2 bg-gray-100 flex flex-col justify-center p-8 lg:p-12 rounded-2xl">
                ...
                <p className="text-gray-500 font-light leading-relaxed">
                  ...
                  bar. Then carefully check the inspection report and the
          ...
          <TabsContent value="buy">
            <div className="flex flex-col md:flex-row items-stretch gap-0">
              ...
              <div className="w-full md:w-1/2 bg-gray-100 flex flex-col justify-center p-8 lg:p-12 rounded-2xl">
                ...
                <p className="text-gray-500 font-light leading-relaxed">
                  Submit your price to engage with the seller. We will manage
                  the communication and notify you as soon as there is a
                  reaction.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-stretch gap-0">
              ...
              <div className="w-full md:w-1/2 bg-gray-100 flex flex-col justify-center p-8 lg:p-12 rounded-2xl">
                ...
                <p className="text-gray-500 font-light leading-relaxed">
                  ...
                  receive a summary of your order. Upon confirmation we will
                  send you a proforma invoice to be paid using one of our safe
                  payment methods.
                </p>
              </div>
            </div>
          ...
          <TabsContent value="pickup">
            <div className="flex flex-col md:flex-row items-stretch gap-0">
              ...
              <div className="w-full md:w-1/2 bg-gray-100 flex flex-col justify-center p-8 lg:p-12 rounded-2xl">
                ...
                <p className="text-gray-500 font-light leading-relaxed">
                  Once we receive your payment we will coordinate the pickup
                  with the seller and inform you of the delivery date.
                </p>
              </div>
            </div>
          </TabsContent>
