      ...
      <div className="py-4 mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl mt-4">
        <div className="relative">
          <h1 className="text-eBlack text-2xl md:text-4xl lg:text-5xl xl:text-7xl md:max-w-lg lg:max-w-[inherit] font-aeonik text-center relative max-w-5xl mx-auto  italic">
            Buy <span className="font-semibold">verified foreign-used </span>{" "}
            heavy
        ...
        <div className="flex justify-center items-center">
          <p className="text-[#747474] text-center text-sm md:text-base font-medium my-4 leading-7 lg:my-8 inline-block max-w-4xl">
            We use proprietary diagnostic software to catch what the human eye
            cannot: odometer fraud, engine tampering, and hidden failures. Every
            machine is verified before it hits the yard, so you can buy,
            finance, or earn passively through Own and Earn with confidence
            across West Africa.
          </p>
        </div>
